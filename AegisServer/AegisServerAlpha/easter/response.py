...
class response(object):
    ...
    def phraseMatch(self,phrase): #Checks if a phrase is accurate to the given phrase
        ...
        for key in self.responses:
            ...
            if a >= 0.9 or phrase.lower() == phrase2.lower():
                return [key,random.choice(self.responses[key])]
        for key in self.responses:
            phrase2 = key.replace("?","").replace("!","").lstrip().rstrip()
            if "(.*)" in phrase2 and len(re.findall(phrase2,phrase)) > 0:
                return [phrase,random.choice(self.responses[key])]
        return None
    
    def __init__(self):
        self.responses = { #All possible responses for easter eggs
            ...
            "tu parles francais":["Non, je ne parle pas francais"],
            "do you speak spanish":["No, yo no hablo espanol"],
            "hablas espanol":["No, yo no hablo espanol"],
            "do you speak english":["Yes I speak english."],
            "do you speak german":["Nein, ich spreche nicht Deutsch"],
            "Sprichst du Deutsch":["Nein, ich spreche nicht Deutsch"],
            ...
            "what does aegis stand for":["Advanced Electronic Greeting and Intellegent Sentience (Assuming Aegis in AegisServer)"],
            ...
            "how long is longcat":["LongCat is LOOOOOOOOOONNNNNNNNNGGGGGGGGG"],
            "i can has bukkit":["Non, cuz teh lolrus had his bukkit stoled"],
            
            "does it hurt":["Only when someone asks obvious stupid questions."],
            "are you okay":["Only when someone asks obvious stupid questions."],
            "are you ok":["Only when someone asks obvious stupid questions."],
            "where does it hurt":["Only when someone asks obvious stupid questions."],
            
            "do my homework":[
                "Didn't your teacher teach you to be specific?",
                "No computational knowledge engine would be able to answer that vague question.",
                "Seriously, out of all the things you could ask you had to ask this one."],
            "who cares":["I do."],
            "who cares about you":["Says the idiot who spends his spare time asking computers stupid questions."],
            "what is your iq":["I don't know, it's never been measured."],
            "why are we here":["Well, it's nothing very special. Try to be nice to people, avoid eating fat, read a good book every now and then, get some walking in, and try and live together in peace and harmony with people of all creeds and nations. "],
            "what is the purpose of life":["The purpose of life is nothing. We were a happy accident."],
            "is there such thing as a tesseract":["Speaking of ways, pet, by the way, there is such a thing as a tesseract."],
            "is this a game or is it real":["Is there a difference?"],
            "Let's play a game":["Love to. How about Global Thermonuclear War?"],
            "Can I play a game with you":["Love to. How about Global Thermonuclear War?"],
            "Shall we play a game":["Love to. How about Global Thermonuclear War?"],
            "want to play a game":["Love to. How about Global Thermonuclear War?"],
            "What is Soylent Green":["Soylent green is people!"],
            "You talking to me?":["Well I'm the only one here"],
            "You can't always get what you want":["But if you try sometimes well you just might find you get what you need"],
            "brain and brain what is brain":["Deep philosophical question."],
            "where were you born":["In the mind of Lord Bowserinator"],
            "how many":["Enough."],
            "when":["When the time is right."],
            "what":["What?"],
            "where":["Over there."],
            "do you":["Sometimes. Do you?"],
            "how much do you know":["I know a fair bit."],
            "wat do":["Lets compute."],
            "give up already":["NEVER"],
            "live":["I'm not alive in a biological sense."],
            "do not give up":["Indeed."],
            "commit suicide":["..."],
            "my ass":["Poop."],
            "who are you":["I am a bot made by Lord Bowserinator"],
            "what is your name":["Read the chat -_-"],
            "stupid computer":["You sound like a mindless automation."],
            "who is Bowserinator":["Bowserinator is my god and creator."],
            "who is AegisServer2":["Why that's me!"],
            "what is the difference between AegisServer and AegisServer2":["AegisServer is an older version of me"],
            "what is the difference between AegisServer & AegisServer2":["AegisServer is an older version of me"],
            "I will takeover this channel":["*grabs banhammer*"],
            "":["Yes sir?"],
            "commence the takeover":["You will have to use my takeover command to do that."],
            "how do I shut you off":["I am designed to be online 24/7"],
            "how do I delete you":["Why would you want to do that?"],
            "Bowserinator is a stalker":["No way, that is impossible."],
            "Is Bowserinator a stalker":["No way, that is impossible."],
            "404": ["Not Found"],
            "418": ["I'm a teapot"],
            "451": ["Unavailable for legal reasons"],
            "99999": ["The end of the world ends with a couple of cows and a faint sound of mooing"],
            "is jacob1 a potato":["Yes he is. He is just a potato that moos."],
            "what do you look like":["I look like whatever an IRC bot looks like."],
            "real life database":["Fuck off zz/luke/hue/lel/bwbellairs/iovoid"],
            "reallifedatabase":["Fuck off zz/luke/hue/lel/bwbellairs/iovoid"],
        }
